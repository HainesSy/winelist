...
export const NEW_ZEALAND_SUBREGIONS = [
  {
    ...
    lat: -41.5140,
    lng: 173.9530,
    terroir: "Broad alluvial valley floors covered in free-draining river stones, greywacke gravels, and sandy-silt loams over clay. High southern sunshine hours paired with cool sea breezes create massive diurnal shifts, supercharging the synthesis of pungent thiols (passionfruit, boxwood) and methoxypyrazines (lemongrass) while locking in crisp natural acidity. Winemakers utilize protective, cool stainless steel fermentations under inert gas to prevent oxidation and preserve explosive tropical and citrus aromatics in Sauvignon Blanc.",
  ...
  },
  {
    ...
    lat: -45.0312,
    lng: 169.1944,
    terroir: "World's southernmost commercial vineyards (45°S) planted on glacial outwash terraces of schist gravels, mica, and wind-blown loess. Semi-continental climate with hot, intense summer days and near-freezing alpine nights concentrates anthocyanins and sugars in Pinot Noir, producing thick skins with vibrant black cherry fruit and wild thyme herbal lift. Cellar techniques include cold-soaking, partial whole-cluster inclusion (15–30%) to add aromatic freshness, and 10 to 14 months of aging in French oak barriques to polish energetic tannins.",
  ...
  },
  {
    ...
    lat: -39.6381,
    lng: 176.7725,
    terroir: "The renowned Gimblett Gravels district, consisting of 800 hectares of deep, stony alluvial gravels deposited by the ancient Ngaruroro River. Low-fertility river gravels restrict vine vigor and radiate daytime heat deep into the night, allowing Cabernet Sauvignon, Merlot, and Syrah to achieve complete phenolic maturity with dark plum and peppery spice. Enologists use traditional Bordeaux-style pump-overs, extended post-fermentation skin maceration, and maturation in French oak barriques to construct structured, age-worthy fine reds.",
  ...
  },
  {
    ...
    lat: -41.2186,
    lng: 175.4594,
    terroir: "Elevated alluvial river terraces composed of deep, free-draining greywacke gravels overlaid with a thin layer of silty loam. Strong, desiccating Antarctic spring winds cause poor fruit set and small berry sizes (hen and chicken), producing low-yielding Pinot Noir with thick skins, savory plum fruit, and profound structural depth. Vignerons employ native yeast fermentation, generous whole-cluster inclusion, and moderate French oak aging, yielding Pinot Noir renowned for savory earthy complexity and Burgundian weight.",
