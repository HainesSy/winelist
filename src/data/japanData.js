...
export const JAPAN_SUBREGIONS = [
  {
    ...
    lat: 35.6600,
    lng: 138.7300,
    terroir: "Alluvial fan terraces and volcanic ash soils (kuroboku) drained by mountain rivers in the shadow of Mount Fuji. High summer humidity and seasonal monsoon rains require traditional high-overhead horizontal Tanadukuri pergola vine training; well-drained volcanic alluvial gravels preserve delicate yuzu citrus, white peach, and subtle phenolic bitterness in Koshu. Winemakers employ gentle whole-bunch pressing and cold fermentation, frequently utilizing sur lie for 5 to 6 months in stainless steel to impart savory umami and textural roundness.",
  ...
  },
  {
    ...
    lat: 36.2500,
    lng: 137.9500,
    terroir: "High alpine river valleys and alluvial gravel terraces (500m to 900m) sheltered by the Japanese Northern Alps, featuring volcanic loam and gravel. Dramatic diurnal temperature shifts (up to 15°C) and cooler overall temperatures restrict berry size, preserving crisp natural malic acidity and developing pure stone fruit in Chardonnay and elegant red fruit in Merlot. Enologists utilize Burgundian techniques for Chardonnay, including French oak barrel fermentation with batonnage, and gentle destemmed macerations for Merlot to preserve refined alpine aromatics.",
  ...
  },
  {
    ...
    lat: 43.1800,
    lng: 140.7700,
    terroir: "Cool northern maritime terraces of volcanic ash, clay-loam, and gravelly slopes overlooking Ishikari Bay. The cold northern climate and short growing season produce small, aromatic berries with electric acidity and low potential alcohol in cool-climate varieties like Pinot Noir, Kerner, and Zweigelt. Gentle low-extraction cellar handling, wild yeast fermentations, and neutral oak aging predominate, preserving pristine fruit purity, delicate floral perfume, and bright northern acidity.",
  ...
  },
  {
    ...
    lat: 38.1500,
    lng: 140.2800,
    terroir: "Inland mountain basin with fertile alluvial loams, volcanic river soils, and gravelly subsoils sheltered by the Ou Mountain range. Hot summer days followed by sharp night cooling create ideal conditions for aromatic development, producing expressive Muscat Bailey A with bright strawberry aromatics and soft, rounded tannins. Winemakers frequently utilize partial carbonic maceration or gentle stainless steel fermentation to accentuate fruity esters while keeping the wine light, playful, and harmonious with Japanese gastronomy.",
