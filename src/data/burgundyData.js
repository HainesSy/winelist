...
export const BURGUNDY_SUBREGIONS = [
  {
    ...
    description: "Burgundy's northernmost outpost, situated 150 km northwest of the Côte d'Or in the Serein River valley, producing crystalline, steel-cut Chardonnays with hallmark green apple, oyster-shell salinity, and flinty tension. The bedrock of Upper Jurassic Kimmeridgian limestone marl—packed with fossilized Exogyra virgula comma-shaped oysters identical to those found in Champagne's Aube—imparts a distinctive chalky minerality found nowhere else in Burgundy. Seven Grand Crus (Les Clos, Blanchot, Bougros, Grenouilles, Preuses, Valmur, and Vaudésir) occupy a single southwest-facing hillside above the village, complemented by 40 Premier Cru climats across both banks. The continental climate brings severe spring frost risk along the valley floor, historically combated by smudge pots (chaufferettes) and aspersion (sprinkler ice-coating), though climate change has moderated recent vintages. Satellite appellations Irancy (Pinot Noir with the ancient César grape) and Saint-Bris (Burgundy's only Sauvignon Blanc AOC) add further diversity to this isolated viticultural island."
  },
  {
    id: 'cote-de-nuits',
    name: "Côte de Nuits",
    ...
    description: "The 'Champs-Élysées of Burgundy' — a narrow 20-kilometre limestone escarpment stretching from Marsannay in the north to Corgoloin in the south, representing the world's most revered sanctuary for terroir-transparent, age-worthy Pinot Noir. This east-facing fault scarp, rising 250–300 metres above the Saône plain, harbours 24 of Burgundy's 33 Grand Crus for red wine, including the legendary Romanée-Conti, La Tâche, Chambertin, Musigny, and Clos de Vougeot. The bedrock of Middle Jurassic Bajocian crinoidal limestone and Bathonian Comblanchien marble, fractured by transverse combes (dry valleys) that channel cool air and expose varied soil strata, creates an extraordinary mosaic of micro-terroirs within mere metres of each other. Each village along the Côte imprints a distinct personality on Pinot Noir—from the sovereign power of Gevrey-Chambertin to the ethereal silk of Chambolle-Musigny and the profound complexity of Vosne-Romanée. The concept of the climat—a precisely delimited parcel defined by its unique geology, aspect, and microclimate—was codified here and inscribed as a UNESCO World Heritage Site in 2015."
  },
  {
    id: 'cote-de-beaune',
    name: "Côte de Beaune",
    ...
    description: "The epicentre of white Burgundy mastery, home to the mythical Montrachet—widely regarded as the greatest dry white wine vineyard on Earth—alongside aristocratic red Crus celebrated for aromatic poise and velvet texture. Stretching south from the hill of Corton (the only Grand Cru in the Côte producing both red and white wines) through Beaune, Pommard, Volnay, Meursault, and the twin villages of Puligny and Chassagne-Montrachet, the Côte de Beaune is broader and gentler in slope than its northern counterpart. Alternating bands of Oxfordian white marls and Bathonian limestone create ideal conditions for Chardonnay on the mid-slopes, while iron-rich red clay rendzinas on steeper grades favour Pinot Noir of exceptional finesse. The village hierarchy encapsulates Burgundy's terroir philosophy: Pommard's muscular Rugiens, Volnay's lace-like Clos des Ducs, Meursault's buttered hazelnut Perrières, and Puligny's steely, crystalline Chevalier-Montrachet. Eight Grand Crus for white wine and one for red anchor a constellation of 29 Premier Cru appellations that together produce the world's most nuanced and age-worthy Chardonnays."
  },
  {
    id: 'hautes-cotes',
    ...
    description: "High-altitude terroirs perched 350–450 metres on the Jurassic limestone plateau west of the Côte d'Or escarpment, providing energetic, refreshing expressions that are thriving with rising global growing-season temperatures. Once considered marginal for ripening Pinot Noir, these windswept hills now consistently produce vibrant reds with crunchy red currant fruit and bracing acidity, alongside crisp mineral Chardonnay and characterful Aligoté. The limestone cap rock is covered with thin clay colluvium and stony debris, offering excellent drainage and cool root-zone temperatures that preserve natural freshness even in warm vintages. Historically, these plateaus supplied everyday vin de pays to Beaune's negotiant houses, but a new generation of ambitious vignerons—including Emmanuel Giboulot and Henri Naudin-Ferrand—has elevated quality dramatically. The Hautes-Côtes represent Burgundy's most compelling value proposition, offering authentic terroir expression at a fraction of the cost of their famous neighbours below."
  },
  {
    id: 'cote-chalonnaise',
    ...
    description: "Vibrant, high-value village and Premier Cru wines delivering authentic Burgundian character across five distinct commune appellations: Bouzeron, Rully, Mercurey, Givry, and Montagny. Unlike the Côte d'Or's continuous escarpment, the Chalonnaise comprises scattered east-facing Jurassic limestone hillsides and clay marl outcrops separated by broader valleys, creating a patchwork of warm amphitheatre sites. Bouzeron holds the unique distinction of being Burgundy's only commune AOC dedicated exclusively to Aligoté Doré, championed by Aubert de Villaine of Domaine de la Romanée-Conti. Mercurey and Givry produce structured, spicy, dark-cherry Pinot Noirs historically favoured by French royalty, while Rully's crisp Chardonnay and Crémant de Bourgogne sparkling wines offer exceptional freshness and value. The region has experienced a quality renaissance since the 1990s, with vignerons like Faiveley, Dureuil-Janthial, and François Lumpp demonstrating that these terroirs can rival many Côte d'Or Premier Crus."
  },
  {
    id: 'maconnais',
    name: "Mâconnais",
    ...
    description: "Sun-drenched southern Burgundy celebrated for opulent, stone-fruit-driven Chardonnays with mineral tension, anchored by the historic Pouilly-Fuissé appellation which was elevated with 22 Premier Cru climats in 2020—the first new Premier Crus designated in Burgundy in decades. The dramatic Mesozoic limestone escarpments of Solutré and Vergisson, rising 500 metres above rolling vineyard slopes, are among the most iconic geological landmarks in the wine world and were a prehistoric hunting site where over 100,000 horse skeletons have been excavated. The warmer, more southerly climate produces earlier-ripening, fuller-bodied Chardonnays compared to the Côte d'Or, with ripe stone fruit, acacia blossom, and a buttery roundness that makes them approachable in youth while the best examples age gracefully for a decade or more. Beyond Pouilly-Fuissé, the appellations of Saint-Véran, Viré-Clessé, and Pouilly-Vinzelles offer excellent value, with Viré-Clessé historically producing honeyed, sometimes botrytis-influenced whites of remarkable depth. The Mâconnais also marks the geological transition zone where Burgundy's Jurassic limestone gives way to the granite of Beaujolais, with Chardonnay accounting for over 90% of plantings."
  }
];
