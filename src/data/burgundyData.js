...
export const BURGUNDY_SUBREGIONS = [
  {
    ...
    lat: 47.81,
    lng: 3.80,
    terroir: "Upper Jurassic Kimmeridgian marl alternating with compact limestone beds packed with fossilized marine oysters (Exogyra virgula). The cool continental northern climate and calcium-rich marl maintain razor-sharp malic acidity and low must pH in Chardonnay, restricting berry size and generating clean oyster-shell nuances. Vignerons prioritize stainless steel or neutral older oak barrels, often conducting malolactic fermentation to soften the searing malic acid while deliberately avoiding heavy new oak to preserve mineral purity.",
  ...
  },
  {
    ...
    lat: 47.18,
    lng: 4.95,
    terroir: "East-facing Bajocian and Bathonian limestone escarpment (250m–300m) with thin topsoil over fractured bedrock and crinoidal limestone. The shallow, well-draining limestone restricts vine vigor, forcing roots deep into fissures and producing tiny, thick-skinned Pinot Noir berries rich in anthocyanins, firm tannins, and violet-red fruit perfume. Cellarmasters frequently utilize partial whole-cluster fermentation and aged French oak barriques with gentle pigéage to harmonize structural tannins without masking delicate floral aromatics.",
  ...
  },
  {
    ...
    lat: 46.98,
    lng: 4.80,
    terroir: "Diverse hillside escarpments alternating between soft Oxfordian marls on high slopes and hard Jurassic limestone on mid-slopes. Marl-rich soils yield opulent, broad-shouldered Chardonnay with profound dry extract and hazelnut richness, while limestone-dominated parcels produce Pinot Noir with silky, supple tannins and perfumed red cherry complexity. White wines undergo barrel fermentation with gentle lees stirring (bâtonnage) and 12–18 months in French oak, while reds receive gentle extraction to accentuate aromatic finesse.",
  ...
  },
  {
    ...
    lat: 47.10,
    lng: 4.82,
    terroir: "Elevated limestone plateau (350m–450m) behind the main Côte, with stony, shallow soils over hard Jurassic limestone bedrock. Cooler temperatures and strong winds prolong the growing season, preserving elevated natural acidity, crunchy cranberry fruit, and tension in Pinot Noir, Chardonnay, and Aligoté. Winemakers favor gentle extractions, temperature-controlled vats, and minimal new oak to avoid overwhelming the delicate, bright red fruit and laser-like acidity.",
  ...
  },
  {
    ...
    lat: 46.75,
    lng: 4.70,
    terroir: "Fragmented limestone and marl ridges with iron-tinted clay topsoils running south from Chagny across Mercurey, Givry, Rully, and Montagny. Excellent hillside drainage and varied sun aspects produce healthy, balanced clusters with expressive fruit aromas, moderate tannin structure, and refreshing acidity in Pinot Noir and Chardonnay. Producers combine stainless steel and seasoned French oak barrels, utilizing moderate maceration times to craft vibrant, food-friendly wines that mature earlier than Côte d'Or bottlings.",
  ...
  },
  {
    ...
    lat: 46.30,
    lng: 4.75,
    terroir: "Rolling limestone hills and iconic fossiliferous crags (Solutré and Vergisson) overlaid with warm calcareous clay and alkaline marls. Warmer southern latitude and sun-drenched limestone slopes ripen Chardonnay reliably, developing ripe stone fruit, melon, and honeysuckle flavors while retaining a vibrant mineral backbone. Vinification ranges from crisp, unoaked stainless steel aging for regional appellations to oak cask fermentation and lees aging for Premier Cru Pouilly-Fuissé, enhancing creamy richness.",
