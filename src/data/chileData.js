...
export const CHILE_SUBREGIONS = [
  {
    ...
    description: "Sheltered beneath snow-crowned Andean heights south of Santiago, Alto Maipo is the noble cradle of Chilean Cabernet Sauvignon. In the late nineteenth century, Don Melchor de Concha y Toro planted pre-phylloxera French cuttings that flourish on their original rootstocks. Chilled nocturnal mountain winds preserve fresh eucalyptus and blackcurrant perfumes, forging aristocratic red wines of sculpted graphite elegance and decades-long cellaring power.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The dramatic natural amphitheater of Apalta is celebrated as the crown jewel of Colchagua viticulture. Pioneers Aurelio Montes and Alexandra Marnier-Lapostolle recognized this warm coastal sun trap as an ideal cradle for luxury reds. Centenarian, ungrafted bush vines produce opulent Carmenère and Syrah, seducing the palate with dark blackberry liqueur, cocoa nibs, cracked black pepper, and velvety richness.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "When visionary winemaker Pablo Morandé planted the first commercial vines here in 1982, his daring foresight sparked a revolutionary cool-climate era for Chile. Chilled by the icy Humboldt Current, thick morning ocean fogs blanket rolling pastures before yielding to crisp sea breezes. The prolonged growing season fosters laser-focused Sauvignon Blanc, Chardonnay, and Pinot Noir singing with grapefruit zest, sea spray, and energetic poise.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Peumo holds a mythical place in wine lore as the sanctuary where Carmenère was miraculously rediscovered in 1994 by French ampelographer Jean-Michel Boursiquot. Cradled along the Cachapoal River and moderated by Lake Rapel breezes, late-harvest grapes ripen to complete physiological perfection. Benchmark estates produce voluptuous red wines brimming with dark blueberry, cured tobacco leaf, sweet paprika, and melted dark chocolate tannins.",
    microTerroirs: [
