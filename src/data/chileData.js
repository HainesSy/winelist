...
export const CHILE_SUBREGIONS = [
  {
    ...
    terroir: "Well-drained alluvial terraces (650m to 900m) composed of rounded gravels, stones, and clay-loam washed down by the Maipo River from the Andes. Cold katabatic nighttime mountain breezes cause diurnal shifts of over 20°C, extending the ripening season to fully mature Cabernet Sauvignon's pyrazines into refined eucalyptus, mint, and cassis with firm, fine tannins. Winemakers employ gentle pump-overs, extended post-fermentation skin maceration, and 16–20 months in French oak barriques to polish the muscular structural tannins into legendary cellar-worthy icons.",
    ...
    description: "Alto Maipo occupies the highest benchlands of the Maipo River basin along the Andean foothills directly south and east of Santiago. In the late nineteenth century, Don Melchor de Concha y Toro and his peers imported pre-phylloxera French vine cuttings to plant on their original rootstocks. Nocturnal mountain winds descending from Andean peaks plunge evening temperatures, extending grape hang-time and preserving fresh varietal aromatics. Cabernet Sauvignon from Puente Alto and Pirque displays hallmark eucalyptus, blackcurrant, and graphite notes, supported by fine-grained tannins that age gracefully for decades.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Natural horseshoe-shaped granite amphitheater featuring colluvial and decomposed granitic soils with pockets of clay. Intense solar radiation trapped by surrounding hills ripens thick-skinned Carmenère, Syrah, and Cabernet Sauvignon to perfection, melting harsh green pyrazines and yielding lush black fruit, cocoa, and sweet, velvety tannins. Cellar practices include selective hand-harvesting at night, gravity-flow fermentation in oak or concrete vats, and aging in new French oak barriques to balance the immense fruit concentration.",
    ...
    description: "Apalta forms a horseshoe-shaped natural amphitheater along the northern bank of the Tinguiririca River within the broader Colchagua Valley. European visionaries Alexandra Marnier-Lapostolle and Aurelio Montes identified this sheltered sun-trap in the 1990s as Chile's premier cradle for luxury red wines. Old dry-farmed bush vines planted in the early twentieth century continue to thrive ungrafted, producing remarkably small berries of immense concentration. Benchmark Carmenère, Syrah, and Cabernet Sauvignon deliver opulent blackberry liqueur, cocoa, cracked black pepper, and supple, velvety richness.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Coastal Cordillera decomposed granite, red clay, and ancient marine sedimentary soils just 4 to 15 kilometers from the Pacific Ocean. Cold ocean currents generate dense morning fog and brisk sea winds that severely slow ripening, preserving soaring natural malic acidity, vibrant pyrazines, and saline minerality in Sauvignon Blanc, Chardonnay, and Pinot Noir. White grapes undergo protective cold-soak maceration and reductive stainless steel fermentation without malolactic conversion, while Pinot Noir receives delicate, low-extraction fermentation.",
    ...
    description: "Casablanca and the adjacent San Antonio and Leyda valleys occupy the rolling coastal range west of Santiago along the Pacific Ocean. Winemaker Pablo Morandé planted the first commercial hillside vines here in 1982, defying conventional skepticism and inaugurating Chile's cool-climate wine era. Dense morning ocean fogs generated by the icy Humboldt Current blanket the vineyards until midday, when crisp maritime breezes moderate ripening. The extended growing season yields laser-focused Sauvignon Blanc, Chardonnay, and Pinot Noir singing with grapefruit zest, sea spray freshness, and energetic acidity.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Sheltered riverside terrace with deep alluvial clay-loam soils over gravelly subsoils, moderated by breezes from Lake Rapel. Deep moisture-retaining clay soils buffer midday heat, providing consistent hydration that allows late-ripening Carmenère to achieve complete physiological maturity, turning astringent tannins into plush, silky dark chocolate notes. Vignerons utilize prolonged gentle fermentation and up to 18 months in fine-grained French oak barriques, allowing micro-oxygenation to soften the dense tannins into benchmark luxury expressions.",
    ...
    description: "Peumo encompasses a sheltered river basin situated sixty kilometers inland along the northern bank of the Cachapoal River. In 1994, French ampelographer Jean-Michel Boursiquot examined Peumo's vineyards and famously identified that vines long thought to be Merlot were actually Carmenère. Deeply rooted ungrafted vines benefit from protective Andean breezes and moderating drafts off Lake Rapel that permit long, late autumn hangs. Benchmark estates craft voluptuous red wines brimming with dark blueberry, cured tobacco leaf, sweet paprika, and melted dark chocolate tannins.",
    microTerroirs: [
