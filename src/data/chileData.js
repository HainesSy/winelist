...
export const CHILE_SUBREGIONS = [
  {
    ...
    description: "Located immediately south of Santiago in the high Andean foothills at 650–900 metres elevation, Puente Alto and Pirque are the historical ground zero for Chilean fine wine and the undisputed kingdom of South American Cabernet Sauvignon. The ancient third alluvial terrace (Terraza 3) of the Maipo River provides deep, rocky, low-fertility gravels with exceptional drainage, forcing vine roots to plunge deep into mineral-rich subsoils. Every evening, dramatic katabatic winds descend from the 6,000-metre Andean peaks, dropping temperatures by up to 20°C and preserving the crisp natural acidity and hallmark eucalyptus-mint aromatics that define Alto Maipo Cabernet. Benchmark estates Almaviva (Rothschild–Concha y Toro), Don Melchor (Concha y Toro), and Viñedo Chadwick (Errázuriz) have repeatedly earned 100-point scores, placing Puente Alto alongside Bordeaux and Napa as a global first-growth terroir. The wines display a signature interplay of cassis intensity, graphite minerality, and silky structural tannins that age gracefully for three decades or more.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Regarded as the 'Napa Valley of Chile', the Colchagua Valley centres on the Apalta amphitheatre—a natural horseshoe-shaped granite bowl that earned official D.O. status in 2018 for its world-class luxury red blends. The decomposed pink granitic colluvium and deep clay-loam foothill benches provide ideal water retention for late-ripening Carmenère and muscular Syrah, while the south-facing orientation shields vines from excessive afternoon heat. The warm Mediterranean climate is tempered by cool maritime breezes funneled through the Tinguiririca River gap from the Pacific, extending the ripening season and building phenolic complexity. Iconic estates Casa Lapostolle (Clos Apalta), Montes (Folly, Alpha M), and Neyen have transformed this former agricultural valley into one of South America's most glamorous fine wine destinations. The resulting wines are monumental in scale—opulent, darkly fruited, layered with cocoa, black pepper, and velvety chocolate tannins.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Pioneered in 1982 by visionary winemaker Pablo Morandé, who planted the first commercial vines against conventional wisdom, Casablanca transformed Chile from a purely red wine country into a world leader in cool-climate whites and Pinot Noir. The freezing Humboldt Current sweeping north along the Pacific coast generates dense morning fog banks (camanchaca) that roll inland daily, moderating summer temperatures and preserving the crisp natural acidity that defines these coastal wines. The Leyda sub-valley within San Antonio sits just 4–15 kilometres from the ocean, making it one of the most maritime-influenced wine zones in South America, with calcareous marine silt soils imparting a distinctive saline minerality. Casablanca's higher inland slopes of decomposed granite over red clay produce textured Chardonnay and surprisingly powerful cool-climate Syrah with white pepper and olive tapenade notes. Together, these twin valleys have established Chile's premier benchmarks for aromatic Sauvignon Blanc, elegant Pinot Noir, and mineral-driven Chardonnay.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The historical sanctuary where Carmenère—long thought extinct after phylloxera devastated Bordeaux—was preserved in Chilean vineyards and dramatically rediscovered in 1994 by French ampelographer Jean-Michel Boursiquot, who identified it among vines mislabelled as Merlot. Peumo's warm, sheltered microclimate within the Cachapoal Valley is protected from cold Pacific fronts by the Coastal Range, providing the sustained heat that notoriously late-ripening Carmenère requires to achieve full phenolic maturity without vegetal bitterness. Deep alluvial clay soils over impermeable subsoil retain moisture throughout the dry growing season, while Lake Rapel and gentle evening river breezes temper afternoon temperature spikes. Concha y Toro's Carmín de Peumo and Terrunyo bottlings have established Peumo as the undisputed world capital for single-varietal Carmenère, producing wines of silky blueberry, dark plum, sweet tobacco, and chocolate complexity. The valley's ungrafted centenarian vines, planted by 19th-century European immigrants, represent an irreplaceable viticultural heritage.",
    microTerroirs: [
