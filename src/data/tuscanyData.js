...
export const TUSCANY_SUBREGIONS = [
  {
    ...
    terroir: "Forested mountainous ridges (250m to 650m) dominated by friable, flaky clay-schist (Galestro) and hard, compact marly limestone (Alberese). High-elevation limestone and schist soils restrict vine vigor, preserving high natural tartaric acidity, bright sour red cherry fruit, and chiseled, savory tannins in Sangiovese. Winemakers ferment in concrete or stainless steel and age wines in large neutral Slavonian or French oak casks (botti), allowing taut tannins to soften without overpowering Sangiovese's delicate floral and dried-herb perfume.",
  ...
  },
  {
    ...
    terroir: "Isolated mountain hill (120m to 650m) featuring four distinct quadrant terroirs: rocky Galestro in the north, marine clay in the south, and sand-gravel in the east and west. Cooler, rocky northern slopes produce high-toned, aromatic Sangiovese Grosso with laser acidity, while the warmer southern quadrant yields bolder, darker fruit with sweeter, broader tannins. Statutory regulations require a minimum of two years in oak barrels (historically large Slavonian oak botti), allowing micro-oxygenation to gradually tame formidable structural tannins into velvety elegance.",
  ...
  },
  {
    ...
    terroir: "Coastal amphitheater along the Tyrrhenian Sea featuring alluvial gravel, sand, and calcareous clay benches against the Colline Metallifere. Intense coastal sunlight and maritime sea breezes promote rapid, even ripening of Cabernet Sauvignon, Merlot, and Cabernet Franc, softening green pyrazines into rich cassis, wild rosemary, and velvety tannins. Enologists employ classic Bordeaux vinification, including temperature-controlled fermentation, gentle pump-overs, and 18 to 24 months in French oak barriques to produce opulent, aristocratic Super Tuscans.",
  ...
  },
  {
    ...
    terroir: "Rolling Pliocene sandy clay hills with marine fossils in Montepulciano, paired with Carmignano's low limestone and sandstone foothills along the Arno River. Sandy-clay soils promote aromatic development in Prugnolo Gentile (Sangiovese), while Carmignano's historic inclusion of Cabernet Sauvignon adds dark cassis fruit and structural backbone to Sangiovese. Wines are aged in seasoned oak casks or tonneaux for two or more years, developing savory leather, dried plum, and tobacco notes while preserving food-friendly Tuscan acidity.",
  ...
  },
  {
    ...
    terroir: "Rolling medieval hill country composed of Pliocene yellow sands, fossilized shells (argille azzurre), and calcareous sandy loam. Warm, well-draining sandy soils impart delicate floral aromatics, bright citrus, and a distinctive bitter almond finish to Vernaccia di San Gimignano while keeping natural acidity crisp. Vignerons utilize protective cold fermentation in stainless steel with several months on fine lees, or small-batch ceramic amphora and oak maturation for Riserva bottlings to build textural complexity.",
