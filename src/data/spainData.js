...
export const SPAIN_SUBREGIONS = [
  {
    ...
    lat: 42.5800,
    lng: -2.7500,
    terroir: "Elevated rolling plateau and terraced slopes (400m–750m) along the upper Ebro River, featuring calcareous clay-limestone and alluvial river gravels. Cool Atlantic air currents and high elevation preserve vibrant tartaric acidity and fine-grained tannins in Tempranillo and Graciano, producing aristocratic fruit with bright red cherry and violet aromatics. Bodegas age wines in American and French oak casks for extended periods, allowing oxidative maturation to develop classical cedar, leather, and vanilla nuances.",
  ...
  },
  {
    ...
    lat: 42.4500,
    lng: -8.7000,
    terroir: "Coastal granite bedrock decomposing into coarse sandy topsoils (xabre) along the tidal estuaries (rías) of Galicia. Hyper-Atlantic rainfall (up to 1,600mm) requires traditional high granite pergola (emparrado) training to prevent rot; acidic, well-draining granite soils preserve electric malic acidity, saline ocean spray, and bright stone fruit in Albariño. Vignerons ferment Albariño in stainless steel, often holding the wine on fine lees (sobre lías) with regular bâtonnage for 6 to 36 months to build a creamy, textured mid-palate that balances vivid Atlantic acidity.",
  ...
  },
  {
    ...
    lat: 42.3000,
    lng: -2.0000,
    terroir: "Warm, arid Mediterranean-influenced plains along the southeastern Ebro basin featuring deep ferruginous red clay, alluvial silt, and round river cobbles (cascajos). The hotter, lower-elevation climate accelerates ripening and lowers titratable acidity, allowing drought-resistant Garnacha and Mazuelo to accumulate high sugars and develop sweet, succulent red berry fruit with soft, rounded tannins. Cellarmasters historically prize these parcels for blending to provide alcoholic warmth, body, and generous fruit flesh to classical Rioja assemblages, or vinify them in concrete vats for juicy, single-varietal Garnacha.",
