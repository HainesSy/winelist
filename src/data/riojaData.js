...
export const RIOJA_SUBREGIONS = [
  {
    ...
    terroir: "Elevated rolling plateau (400m–700m) south of the Ebro River, featuring calcareous clay, ferruginous red clay, and alluvial river gravels. Cool Atlantic winds and elevated altitude preserve vibrant tartaric acidity and fine-grained tannins in Tempranillo and Graciano, producing elegant, fresh, and aromatic fruit. Bodegas traditionally practice long aging in seasoned American oak barrels (3 to 5+ years for Gran Reserva), followed by prolonged bottle rest to develop classical cedar, vanilla, and cigar box complexities.",
    ...
    description: "Rioja Alta occupies the elevated western sector of the Rioja DOCa along the upper Ebro River, centered around the railway town of Haro. Bordeaux merchants established headquarters in the Barrio de la Estación during the 1860s phylloxera crisis, introducing French barriques and modern oxidative cellar techniques. Century-old bodegas like López de Heredia and La Rioja Alta preserved this classical heritage, aging estate wines for decades in seasoned American oak casks. Tempranillo and Graciano flourish here, yielding aristocratic Gran Reservas marked by tart red cherry, dried dill, cedar, and extraordinary cellar stamina.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Steep terraced south-facing parcels of chalky white calcareous clay-limestone sheltered beneath the limestone cliffs of the Sierra de Cantabria. Highly alkaline chalk soils stress the vines and retain vital moisture, giving Tempranillo electric acidity, chalky minerality, and vibrant violet floral perfume with smaller berry size. Modern vignerons highlight single-vineyard (viñedo singular) terroirs through shorter macerations and aging in fine-grained French oak barriques to accentuate mineral tension and primary fruit purity.",
    ...
    description: "Rioja Alavesa extends along the northern bank of the Ebro River within the Basque province of Álava, sheltered beneath the Sierra de Cantabria. Medieval walled hill towns like Laguardia sit above subterranean labyrinthine cellars carved during the tenth century to store wine and shelter citizens during border wars. Contemporary vignerons like Telmo Rodríguez have led a single-vineyard quality renaissance, rejecting regional blending to highlight historical village parcel distinctions. Hillside Tempranillo benefits from cool mountain breezes, producing expressive red wines of vibrant floral perfume, dark berry fruit, and elegant structural precision.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "High-altitude Castilian plateau (750m to 1,000m) with alternating layers of chalk, limestone marl, sand, and alluvial Duero river gravels. Extreme diurnal swings of up to 25°C and intense UV radiation cause Tinto Fino (Tempranillo) to develop thick, ink-black skins loaded with anthocyanins, bold tannins, and concentrated blackberry flavors. Cellarmasters employ temperature-controlled extraction and extended aging in a combination of new French and American oak barriques to tame the immense tannin concentration into a monumental structure.",
  ...
  },
  {
    ...
    terroir: "Vertiginous terraced amphitheaters of decomposing Devonian black and reddish slate with mica (llicorella). Deep-rooting ancient bush vines penetrate 15+ meters through vertical slate fissures in search of water, producing minuscule yields (less than 1 kg per vine) of intensely concentrated Garnacha and Cariñena. Enologists utilize open-top wood or concrete fermentations with careful temperature control, followed by 12 to 18 months in French oak barriques to soften the massive structural tannins and integrate the high natural alcohol.",
