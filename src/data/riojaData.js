...
export const RIOJA_SUBREGIONS = [
  {
    ...
    description: "Centering on the historic station district in Haro, Rioja Alta is the heartland of legendary nineteenth-century bodegas like López de Heredia and La Rioja Alta. Atlantic weather systems bring cool nights that preserve vibrant acidity in Tempranillo. Prolonged American oak cask aging produces the classical aristocratic style marked by red cherries, vanilla, cedar, and extraordinary cellar longevity.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Perched within the Basque province of Álava beneath the Sierra de Cantabria, Rioja Alavesa is famed for medieval hilltop villages like Laguardia. Sheltered hillside terraces catch steady mountain breezes, coaxing Tempranillo into expressive floral refinement. Modern vignerons lead a dynamic single-vineyard movement, crafting site-specific wines of crystalline precision, dark berry fruit, and elegant French oak polish.",
    microTerroirs: [
