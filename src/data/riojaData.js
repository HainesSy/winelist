...
export const RIOJA_SUBREGIONS = [
  {
    ...
    description: "Centering on the historic station district (Barrio de la Estación) in Haro, Rioja Alta is the heartland of historic centuries-old bodegas. Five iconic houses—López de Heredia, CVNE, Muga, La Rioja Alta, and Roda—sit within walking distance of each other here. The subregion features a 500m average elevation and calcareous clay over limestone bedrock, heavily influenced by Atlantic weather systems. The resulting wines are heavily Tempranillo-dominated and designed for extended aging in traditional American oak. This produces the classic, aristocratic style of Rioja marked by elegant red fruit, vanilla, cedar, and tremendous longevity.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Located within the Basque province of Álava, Rioja Alavesa is famous for dramatic medieval hilltop villages like Laguardia, Samaniego, Labastida, and Elciego. The terroir here is defined by calcareous clay soils sitting atop the pure white Sonsierra limestone bedrock. It is a striking region of contrasts, where historic producers like Marqués de Riscal operate alongside the iconic modern architecture of Frank Gehry. More recently, this subregion has led the single-vineyard (viñedo singular) revolution, championing site-specific wines over traditional aging classifications. The resulting Tempranillo wines are celebrated for their precise acidity, chalky minerality, and French oak refinement.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The 'Golden Mile' (Milla de Oro) of Spanish fine wine stretches through the provinces of Valladolid and Burgos along the Duero River. This is one of the highest plateaus in European viticulture, sitting at 800-1000m altitude on the Meseta Central. The extreme climate delivers brutal 25°C diurnal temperature swings, locking in acidity while building massive fruit concentration. The indigenous Tinta del País or Tinto Fino (a thick-skinned Tempranillo clone) thrives in these harsh conditions. It is home to Spain's most iconic first growth, Vega Sicilia Único, whose inaugural 1915 vintage set the standard for majestic, aristocratic Spanish reds.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Priorat is one of only two Qualified DOCa/DOQ regions in Spain alongside Rioja, nestled in an extreme mountain amphitheater. The terroir is defined by deep, Carboniferous-era black llicorella slate that forces vines to dig deep for survival. Ancient, low-yielding bush vines of Garnacha and Cariñena cling to vertiginous terraces carved into these unforgiving slopes. The region was rescued from obscurity during its late 1980s renaissance by visionaries like René Barbier, Álvaro Palacios, and Clos Mogador. Today, it produces some of Spain's most intense, mineral-soaked, and legendary red wines.",
    microTerroirs: [
