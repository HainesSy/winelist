...
export const LOIRE_SUBREGIONS = [
  {
    ...
    terroir: "Ancient metamorphic and igneous bedrock of the Armorican Massif, including orthogneiss, amphibolite, granite, and gabbro with shallow clay topsoils. Cool Atlantic ocean winds and nutrient-poor crystalline bedrock restrict vine vigor, producing small Melon de Bourgogne berries with modest sugar accumulation, searing acidity, and saline minerality. The wine is matured directly on its fermentation lees (sur lie) over winter without racking, undergoing regular bâtonnage to absorb mannoproteins that soften the brisk acidity and add creamy texture.",
  ...
  },
  {
    ...
    terroir: "The geological convergence of the Armorican Massif dark schist (Anjou Noir) with the Paris Basin white chalky tuffeau (Anjou Blanc). Dark, heat-retaining schists in Savennières force Chenin Blanc roots deep, yielding austere, powerful wines with high dry extract and commanding acidity, while Saumur's tuffeau yields supple, floral Cabernet Franc. Savennières requires extended lees aging in neutral oak foudres to soften its formidable phenolics, whereas Saumur-Champigny is bottled with gentle extraction to highlight fresh red fruit and crushed stone minerality.",
  ...
  },
  {
    ...
    terroir: "Porous Turonian white chalk limestone (tuffeau) and river valley gravel benches (graviers) along the Loire and Vienne rivers. Spongy tuffeau absorbs excess winter moisture and releases it during summer drought, allowing Chenin Blanc to achieve electric acidity across dry and sweet styles, and Cabernet Franc to develop silky tannins and violet-graphite perfume. Vignerons ferment Chenin in ancient tuffeau cave cellars using neutral oak barrels, while Cabernet Franc is vinified with gentle pump-overs and matured in large wooden vats to showcase aromatic purity.",
  ...
  },
  {
    ...
    terroir: "The famous geological trio: fossiliferous Kimmeridgian marl (terres blanches), hard Oxfordian limestone pebbles (caillottes), and flinty Cretaceous quartz (silex). Chalky limestone maintains low must pH and vibrant malic acidity in Sauvignon Blanc, while silex flint reflects intense heat into the canopy to impart smoky gunflint and mineral notes. Winemakers favor cool stainless steel fermentation with several months of fine lees aging to build mid-palate richness, though top silex parcels are occasionally matured in large neutral oak demi-muids.",
