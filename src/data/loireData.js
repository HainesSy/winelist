...
export const LOIRE_SUBREGIONS = [
  {
    ...
    description: "The Atlantic gateway to the Loire Valley, centered around the Sèvre and Maine rivers south of Nantes where the river empties toward the ocean. The geological foundation rests on the ancient, eroded crystalline bedrock of the Armorican Massif, dominated by Orthogneiss, Clisson granite, and Gorges gabbro and amphibolite that impart profound electric salinity. Melon de Bourgogne, introduced here after the devastating Great Frost of 1709 wiped out traditional red vines, thrives in this high-humidity maritime climate with cool summers and regular ocean rainfall. While entry-level Muscadet Sèvre-et-Maine Sur Lie delivers classic briny freshness for oysters, the officially delimited Crus Communaux (such as Clisson, Gorges, and Le Pallet) mandate 18 to 36 months of lees contact, producing structured, ageworthy whites of laser mineral tension. Benchmark vignerons including Domaine de la Pépière, Jo Landron, and Domaine de l'Écu have established this ocean-cooled district as a world-class bastion of biodynamic viticulture."
  },
  {
    id: 'anjou-saumur',
    ...
    description: "The historical viticultural engine of the Middle Loire spans a dramatic geological frontier between the dark Precambrian metamorphic schist of 'Anjou Noir' in the west and the soft, white Cretaceous tuffeau limestone of 'Anjou Blanc' and Saumur in the east. On the windswept schist bluffs of Savennières, Chenin Blanc achieves its most uncompromising, bone-dry, and austere mineral expression, exemplified by Nicolas Joly's historic biodynamic monopole, Coulée de Serrant. Further south, the morning autumn river mists of the Layon River nurture noble rot (Botrytis cinerea), giving rise to Quarts de Chaume Grand Cru—the only officially designated Grand Cru AOC in the entire Loire Valley—and the golden nectars of Bonnezeaux. Saumur serves as both the sparkling wine capital of the Loire, with vast underground cellars carved into Turonian tuffeau storing millions of bottles of Crémant de Loire, and the home of aristocratic, floral Cabernet Franc in Saumur-Champigny. Landmark estates such as Clos Rougeard (Foucault brothers), Domaine Belargus, and Domaine Guiberteau have elevated Anjou-Saumur into one of France's most sought-after fine-wine epicenters."
  },
  {
    id: 'touraine',
    ...
    description: "The Renaissance cultural heart of the Loire Valley, affectionately christened 'The Garden of France' and immortalized in the gastronomic writings of François Rabelais. The terroir is defined by the porous white Turonian chalk known as tuffeau, which forms dramatic river bluffs into which monumental royal châteaux and labyrinthine underground aging cellars are excavated. Along the Vienne and Loire riverbanks, alluvial gravel terraces (Varennes) and tuffeau-rich hillside slopes (Aubuis) nurture benchmark expressions of Cabernet Franc in Chinon, Bourgueil, and Saint-Nicolas-de-Bourgueil, ranging from crunchy red-fruited bistrot wines to muscular, age-worthy cellar titans. For white wines, Vouvray and Montlouis-sur-Loire demonstrate the kaleidoscopic versatility of Chenin Blanc across sparkling (Pétillant), dry (Sec), off-dry (Demi-Sec), and unctuous late-harvest (Moelleux) styles, underpinned by intense acidity and smoky silex flint notes. Historic enclaves like Cour-Cheverny preserve ancient viticultural relics, notably the rare, high-acid Romorantin grape introduced by King Francis I in 1519, alongside benchmark biodynamic vignerons such as Domaine Huet and Bernard Baudry."
  },
  {
    id: 'centre-loire',
    ...
    description: "Perched on rolling hillside amphitheaters 200 kilometres south of Paris along the upper reaches of the Loire River, the Centre-Loire represents the global summit for mineral-driven Sauvignon Blanc and elegant cool-climate Pinot Noir. Geologically, the region forms the southern rim of the Paris Basin, directly sharing the celebrated Mesozoic limestone strata found in Chablis: fossil-packed Kimmeridgian marls (Terres Blanches), stony Oxfordian limestone (Caillottes), and Cretaceous flint outcroppings (Silex). In Sancerre and its right-bank neighbour Pouilly-Fumé, these distinct soil types imprint unmistakable aromatic signatures, from the razor-sharp citrus and gunflint smoke of Silex to the chalky salinity and textural weight of Terres Blanches. The continental climate brings severe winter cold, spring frost hazards, and warm summers with substantial diurnal shifts that allow Sauvignon Blanc to develop intense thiols and pyrazines while retaining electric natural acidity. Benchmark domaines including Didier Dagueneau, Edmond Vatan, Domaine Vacheron, and François Cotat craft collectible, single-parcel masterworks that redefine the ceiling of Sauvignon Blanc longevity."
  }
];
