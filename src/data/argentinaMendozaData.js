...
export const MENDOZA_SUBREGIONS = [
  {
    ...
    lat: -33.5500,
    lng: -69.1500,
    terroir: "High-altitude alluvial benchlands (900m to 1,600m+) beneath the Andes feature gravels richly coated in calcium carbonate (caliche) and coarse sand. Extreme diurnal temperature swings of up to 22°C and intense UV radiation stimulate thick grape skins and dense anthocyanins in Malbec while preserving high natural acidity. Enologists ferment in unlined concrete eggs or neutral foudres with gentle pigeage to highlight fine, chalky tannins and electric floral freshness.",
  ...
  },
  {
    ...
    lat: -33.0500,
    lng: -68.8800,
    terroir: "Alluvial terraces along the Mendoza River (850m to 1,100m) consist of deep clay-loam over round riverbed gravels. Generous solar warmth and balanced water retention allow root systems to delve deep, moderating hydric stress to yield plump Malbec berries with supple skin tannins and lush plum fruit. Winemakers utilize longer post-fermentation maceration and 12 to 18 months in French oak barriques to enhance structural complexity and integrate the velvety fruit.",
  ...
  },
  {
    ...
    lat: -33.0000,
    lng: -68.7500,
    terroir: "Warm lower-elevation plains (650m to 800m) feature deep sandy loam, gravelly beds, and stony silt deposits. High summer daytime heat accelerates ripening, lowering titratable acidity while developing sweet, jammy fruit profiles and rounded tannins in Malbec and old-vine Cabernet. Cellar strategies emphasize temperature-controlled stainless steel fermentations to prevent heat spikes, selective early picking for freshness, and moderate oak contact.",
  ...
  },
  {
    ...
    lat: -34.6000,
    lng: -68.3500,
    terroir: "Elevated river valleys along the Diamante and Atuel rivers (600m to 800m) feature stony alluvial soils, sand, and calcareous pockets. A cooler southerly latitude combined with moderate altitude lengthens the growing season, promoting balanced phenolic ripeness without excessive alcohol in late-ripening Chenin Blanc and Cabernet. Vignerons employ stainless steel and seasoned large wood casks, avoiding heavy extraction to highlight crisp acidity and bright red fruit.",
