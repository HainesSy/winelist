...
export const BEAUJOLAIS_SUBREGIONS = [
  {
    ...
    lat: 46.1800,
    lng: 4.7000,
    terroir: "Precipitous slopes of eroded pink granite (gore), blue volcanic diorite (roches bleues), and manganese-rich veins across rolling hills (250m to 450m). Highly acidic, nutrient-poor granitic soils suppress Gamay's vigor, concentrating skin pigments and phenolic tannins while preserving crunchy red-fruit acidity. Leading vignerons practice traditional semi-carbonic maceration with whole clusters or Burgundian-style destemmed fermentation with gentle pigéage and aged foudres to emphasize terroir depth.",
  ...
  },
  {
    ...
    lat: 46.1200,
    lng: 4.6200,
    terroir: "Rolling hillside vineyards on decomposed granite sandy loam mixed with schist and clay gravels. Excellent slope drainage and moderate fertility encourage balanced berry size with bright, juicy acidity, showcasing fresh cherry, wild strawberry, and subtle granite minerality in Gamay. Producers typically employ whole-cluster semi-carbonic maceration for 8 to 12 days in concrete or stainless steel vats, preserving succulent fruit vibrancy without extracting excessive astringent tannins.",
  ...
  },
  {
    ...
    lat: 45.9200,
    lng: 4.6800,
    terroir: "Undulating southern hills dominated by clay-limestone soils rich in golden ochre-colored Jurassic limestone (pierres dorées). Richer, alkaline clay-limestone soils produce slightly more vigorous vines with plumper berries, softer skin tannins, and gentle acidity, making Gamay exceptionally fruity and supple. Winemaking relies on classic short carbonic maceration (4 to 6 days) under carbon dioxide, followed by immediate pressing and stainless steel maturation to highlight candied berry notes.",
