...
export const MOSEL_SUBREGIONS = [
  {
    ...
    terroir: "Precipitous, vertiginous slopes (up to 70° gradient) composed of weathered Devonian blue and grey slate with minimal topsoil along looping river meanders. Dark, heat-retaining slate absorbs radiant solar warmth by day and releases it overnight, providing crucial thermal buffering that allows Riesling to ripen slowly at 50°N latitude while preserving electric tartaric acidity. Cellarmasters often arrest fermentation via chilling or sulfur additions to preserve natural residual grape sweetness, creating the hallmark tension between piercing slate acidity and delicate residual sugar across the Prädikat hierarchy.",
    ...
    description: "The Mittelmosel covers the central fifty-kilometer gorge of the Mosel River between the Roman city of Trier and Traben-Trarbach. Roman magistrate Decimus Magnus Ausonius documented these terraced riverside amphitheaters in 371 AD in his celebrated Latin poem Mosella. Legendary crus like Wehlener Sonnenuhr and the historic Berncasteler Doctor—whose wine reputedly cured a fourteenth-century archbishop—set enduring benchmarks for site-specific viticulture. Reflected river sunlight ripens Riesling slowly, producing low-alcohol white wines shimmering with white peach, lime blossom, and miraculous feather-weight balance.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Cooler, narrow tributary valleys with hard Devonian greywacke, quartzite, and fissile red-grey slate on wind-exposed steep slopes. Higher elevation and alpine-like drafts delay flowering and harvest, producing small, thick-skinned Riesling berries packed with crystalline green apple, white peach, razor-sharp acidity, and deep smoky minerality. Fermentation is carried out in historic neutral 1,000-liter oak casks (Fuder), allowing subtle micro-oxygenation to soften searing acidity without imparting wood tannins.",
    ...
    description: "The Saar and Ruwer river valleys form two cool-climate tributary corridors entering the Mosel River near the ancient city of Trier. Medieval monastic estates like Karthäuserhof and Maximin Grünhaus cleared these windswept hillsides, establishing independent winemaking domains that have endured for centuries. On the mythical Scharzhofberg hill, Egon Müller and his ancestors have preserved old ungrafted Riesling vines that produce some of the world's most sought-after sweet elixirs. Cold mountain drafts from the Hunsrück forests preserve soaring natural acidity, yielding Rieslings of weightless grace, electric green apple, and diamond-cut cellar longevity.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "South-facing hillside amphitheater sheltered by the Taunus Mountains along the Rhine River elbow, composed of Taunus quartzite, loess, and calcareous loam. Direct south-facing sun exposure and river solar reflection ripen Riesling to full golden maturity, developing ripe peach, apricot, and structural body, while Assmannshausen's steep slate slopes ripen savory Pinot Noir. Vignerons focus on dry (Trocken and Grosses Gewächs) vinification, aging wines in traditional German oak casks (Stückfass) to enhance dry extract and savory ageability.",
    ...
    description: "The Rheingau forms a continuous south-facing bank thirty kilometers long where the Rhine River turns westward between Wiesbaden and Lorchhausen. Cistercian monks constructed the fortified monastery of Kloster Eberbach in 1136, establishing an influential center of viticultural scholarship and international wine trade. In 1775, a courier bearing harvest permission arrived late at Schloss Johannisberg, leading to the intentional discovery and codification of noble-rot Spätlese. The region produces aristocratic, dry Grosses Gewächs Rieslings brimming with ripe apricot and spice, alongside historical Spätburgunder from the steep slopes of Assmannshausen.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Exceptional geological tapestry in the Nahe (volcanic rhyolite, porphyry, Rotliegend red sandstone) and Pfalz's warm rain shadow soils (colored sandstone, limestone, loess, and basalt). The mineral diversity and warm microclimates produce Riesling with unmatched aromatic complexity, marrying the electric mineral tension of the Mosel with the ripe stone-fruit power of the Pfalz. Winemakers emphasize site-specific single-vineyard fermentations in large neutral casks, using extended lees contact to round out the expansive palate while preserving vibrant freshness.",
    ...
    description: "The Nahe River basin and the adjacent Pfalz wine road occupy the sheltered eastern flank of the Haardt mountains in southwestern Germany. Master vigneron Helmut Dönnhoff brought the Nahe to international prominence by demonstrating that steep river bluffs could produce Riesling uniting Mosel filigree with Pfalz power. Southward in the Pfalz, the historic Three Bs—Bassermann-Jordan, von Buhl, and Bürklin-Wolf—spearheaded Germany's quality revolution by pioneering dry single-vineyard crus. Warm ambient temperatures foster almond blossoms and ripe yellow peach flavors in dry Grosses Gewächs Riesling, alongside structured, savory Spätburgunder.",
    microTerroirs: [
