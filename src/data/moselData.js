...
export const MOSEL_SUBREGIONS = [
  {
    ...
    description: "The historic heart of the Mosel Valley stretching from Zell to Trier is home to the most famous Riesling vineyards on Earth. Here, an exclusive Riesling monoculture clings to extreme 60-70° slope gradients, forming the steepest vineyards in the world. The underlying Devonian blue and grey slate provides crucial heat retention and solar reflection. Individual Einzellagen like Wehlener Sonnenuhr, Bernkasteler Doctor, Ürziger Würzgarten, and Erdener Prälat produce benchmark wines regulated by the Prädikat quality hierarchy. These vertiginous sites yield expressions of crystalline purity, vivid acidity, and ageworthy potential.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The colder tributary valleys south and east of Trier amplify the cool marginal climate, producing some of the most aristocratic German Rieslings. The combination of greywacke and Devonian slate bedrock forces vine roots deep to find nutrients. Famous estates like Egon Müller at Wiltinger Scharzhofberg, von Schubert at Maximin Grünhaus, and Karthäuserhof set the standard. In cool vintages, these extreme conditions yield wines with razor-sharp acidity and profound crystalline purity. Their searing acid backbone allows both sweet and dry expressions unmatched aging potential.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The historical epicenter of noble German viticulture is defined by the Rhine's dramatic elbow, creating a unique stretch of south-facing exposure. This continuous solar radiation is protected by the Taunus Mountains, sheltering communes like Hochheim, Rüdesheim, and Assmannshausen. It was here at Schloss Johannisberg in 1775 that the Spätlese (late harvest) style was famously discovered due to a late-arriving courier. The region's rich viticultural history is deeply intertwined with the Cistercian heritage of Kloster Eberbach. Today, it remains a powerhouse for muscular, aristocratic dry Rieslings and historic Spätburgunder.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "These dynamic southern regions lead Germany's dry wine revolution, showcasing incredible geological and climatic diversity. The Nahe is the most geologically diverse German region, featuring a mosaic of volcanic porphyry, quartzite, slate, and sandstone that elevates sites like Dönnhoff's Hermannshöhle and Felsenberg. To the south, the Pfalz boasts the 80km Deutsche Weinstraße and a warmer, sun-drenched climate. Its Mittelhaardt core—encompassing Forst, Deidesheim, Ruppertsberg, and Wachenheim—is home to historic estates like Bürklin-Wolf, von Buhl, and Bassermann-Jordan. Together, they produce some of the most powerful, structurally imposing dry Rieslings in the world.",
    microTerroirs: [
