...
export const PORTUGAL_SUBREGIONS = [
  {
    ...
    lat: 41.1600,
    lng: -7.5300,
    terroir: "Vertiginous stepped terraces carved into vertical metamorphic schist (xisto) fractures that plunge into the Douro River canyons. Schist fractures allow vine roots to delve up to 20 meters deep for moisture during torrid summers, yielding tiny, thick-skinned Touriga Nacional and Franca berries packed with anthocyanins and firm tannins. Grapes are traditionally foot-trodden in open granite lagares to extract color and tannin without crushing bitter seeds, destined for fortification into immortal Vintage Port or aging in French oak barriques for iconic dry reds.",
  ...
  },
  {
    ...
    lat: 40.5500,
    lng: -7.7500,
    terroir: "Elevated granite plateau (400m to 800m) sheltered by surrounding mountains, featuring coarse weathered granite sand (saibro) and schist veins. High elevations and cold mountain nights preserve high natural acidity and moderate sugar accumulation, giving Touriga Nacional and Jaen translucent elegance, floral violet perfume, and chiseled tannins. Red wines undergo gentle fermentation and aging in neutral oak foudres or seasoned barriques, while white Encruzado is fermented in oak barrels with batonnage to develop nutty complexity.",
  ...
  },
  {
    ...
    lat: 38.6000,
    lng: -7.6500,
    terroir: "Vast undulating plains and mountain slopes of granitic sand, schist, clay, and marble-derived limestone outcroppings. Scorching summer heat is balanced by water-retaining clay subsoils, producing rich, sun-ripened Aragonez and Alicante Bouschet with lush dark berry fruit and rounded tannins. Winemakers blend modern temperature-controlled stainless steel fermentation with the revived ancient Roman tradition of fermenting and aging wines in giant clay amphorae (talhas).",
  ...
  },
  {
    ...
    lat: 42.0800,
    lng: -8.4500,
    terroir: "Lush, high-rainfall granitic coastal hills and river terraces along the Minho River bordering Galicia. High Atlantic precipitation is mitigated by well-drained granitic soils, allowing Alvarinho to achieve intense aromatic concentration while retaining crystalline natural tartaric acidity. Leading producers employ cold skin maceration, fine lees stirring, and oak barrel fermentation, elevating Alvarinho into a dry, serious white wine with decades of aging capacity.",
  ...
  },
  {
    ...
    lat: 40.3800,
    lng: -8.5200,
    terroir: "Maritime coastal plain of heavy, moisture-retentive chalky clay (barro) interspersed with sandy coastal strips (areias). Cool Atlantic fogs and dense clay soils force late-ripening Baga to mature slowly, producing small berries with high acid levels and formidable, astringent skin tannins. Skilled vignerons utilize gentle whole-berry macerations and long maturation in large neutral wooden vats or seasoned casks, transforming Baga's fierce tannins into an ethereal, truffle-scented masterpiece.",
