...
export const ITALY_OTHER_SUBREGIONS = [
  {
    ...
    lat: 45.5200,
    lng: 10.9200,
    terroir: "Terraced hillside limestone, dolomitic rocks, and volcanic basalt outcroppings in the Monti Lessini foothills. The well-drained, alkaline hillside soils restrict vine vigor, producing loose clusters of thick-skinned Corvina and Rondinella ideal for post-harvest drying (appassimento) without rot. Grapes are dried for 3 to 4 months on bamboo mats losing 30–40% water, followed by slow winter fermentation and years of maturation in large Slavonian oak botti to yield monumental Amarone.",
  ...
  },
  {
    ...
    lat: 37.7500,
    lng: 15.0000,
    terroir: "High-altitude terraced slopes (500m to 1,000m+) of black volcanic tephra, decomposed lava flows (sciara), and pumice on Mount Etna. Extreme diurnal swings and porous volcanic ash stress century-old ungrafted bush vines, yielding pale-colored Nerello Mascalese with soaring acidity, volcanic flint minerality, and firm nebbiolo-like tannins. Vignerons conduct long, gentle macerations in temperature-controlled steel or traditional palmenti, aging the wines in neutral oak botti or tonneaux to let volcanic tension and wild berry fruit shine.",
  ...
  },
  {
    ...
    lat: 46.1700,
    lng: 9.8700,
    terroir: "Vertiginous south-facing granite terraces and dry stone walls (muretti) along the alpine Adda River valley. High alpine solar radiation combined with cool mountain drafts allows late-ripening Chiavennasca (Nebbiolo) to achieve phenolic ripeness while retaining razor-sharp acidity and alpine herb aromatics. For Sforzato DOCG, grapes are dried for over 100 days before fermentation, yielding intense, full-bodied reds aged extensively in oak casks to soften crystalline alpine tannins.",
  ...
  },
  {
    ...
    lat: 46.4500,
    lng: 11.2800,
    terroir: "Steep alpine terraces (200m to 1,000m) in the Adige valley combine porous limestone gravels and volcanic porphyry beneath the Dolomites. Cool glacial downdrafts meet intense alpine sunlight, preserving piercing natural acidity and delicate aromatic monoterpenes in Pinot Grigio, Gewürztraminer, and Kerner while curbing vegetative vigor. Winemakers utilize temperature-controlled stainless steel fermentation with fine lees aging to maintain pristine aromatic purity, using neutral oak tonneaux for indigenous Lagrein to soften dark berry tannins.",
  ...
  },
  {
    ...
    lat: 46.0000,
    lng: 13.5000,
    terroir: "Alternating layered strata of calcareous marl and sandstone known locally as flysch or ponca, backed by the Julian Alps. The mineral-dense ponca breaks down into clay-loam that regulates moisture, allowing Friulano, Ribolla Gialla, and Sauvignon to develop intense aromatic precursors, deep savory salinity, and textured phenolics. Producers excel in both stainless steel lees-aged expressions and historic extended skin-contact orange wine macerations in Georgian amphorae (qvevri) or large oak casks.",
  ...
  },
  {
    ...
    lat: 40.9500,
    lng: 14.9500,
    terroir: "High-altitude inland Apennine hills (400m to 700m) with volcanic ash and pumice deposits overlaid on calcareous clay and limestone. Cool mountain climate and nutrient-rich volcanic soils lengthen the growing season into November, yielding tiny Aglianico berries with immense tannin density, dark fruit, and towering acidity. Winemakers conduct extended maceration followed by a minimum of three years aging (at least one in wooden barrels) to polymerize fierce tannins into the legendary 'Barolo of the South.'",
