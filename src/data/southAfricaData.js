...
export const SOUTH_AFRICA_SUBREGIONS = [
  {
    ...
    lat: -33.9321,
    lng: 18.8602,
    terroir: "Undulating valleys and dramatic mountain foothills of ancient decomposed granite (Oakleaf and Tukulu soils) over water-retaining clay subsoils. Decomposed granite provides balanced drainage while underlying clay buffers hot summer days, allowing Cabernet Sauvignon and Pinotage to develop thick skins, concentrated blackcurrant fruit, and ripe, supple tannins. Winemakers employ classical Bordeaux-style vinification with temperature-controlled pump-overs and 18 to 22 months of aging in French oak barriques, creating cellar-worthy, structured red wines.",
  ...
  },
  {
    ...
    lat: -33.4500,
    lng: 18.7333,
    terroir: "Rugged, arid landscape dominated by the weathered granite dome of the Paardeberg and decomposed Malmesbury shale hills. Harsh, unirrigated conditions force dry-farmed old bush vines to produce tiny, concentrated Syrah and Chenin Blanc berries with high skin-to-juice ratios, intense flavor concentration, and savory earthiness. The revolutionary Swartland Independent movement emphasizes whole-cluster pressing, native yeast fermentation, and aging in neutral concrete eggs, large foudres, or old wooden barrels to preserve raw site expression.",
  ...
  },
  {
    ...
    lat: -34.3800,
    lng: 19.2500,
    terroir: "Narrow valley framed by Babylonstoren mountains, featuring Bokkeveld shale-derived clay soils and weathered Table Mountain sandstone. Direct maritime breezes from the freezing Benguela Current cool the valley, extending the growing season and preserving bright acidity, fine-grained tannins, and savory cherry notes in Pinot Noir and Chardonnay. Vignerons utilize Burgundian methods, including barrel fermentation, gentle lees stirring, and light-handed French oak aging to craft wines of crystalline tension and Burgundian poise.",
  ...
  },
  {
    ...
    lat: -34.0200,
    lng: 18.4200,
    terroir: "East-facing slopes of the Constantiaberg mountain composed of ancient decomposed granite over clay subsoils overlooking False Bay. Cool ocean breezes and afternoon mountain shade protect grapes from heat spikes, allowing Muscat de Frontignan to shrivel on the vine for legendary Vin de Constance without losing vibrant natural acidity. Late-harvest Muscat is vinified through slow fermentation and aged for several years in French and Hungarian oak barrels, balancing luscious residual sweetness with electric natural acidity.",
  ...
  },
  {
    ...
    lat: -33.9100,
    lng: 19.1200,
    terroir: "Deep mountain valley surrounded by towering peaks, featuring alluvial sandy loam on the valley floor and weathered granite-sandstone on upper slopes. Warm valley floor temperatures promote generous fruit ripening in Cabernet Sauvignon and Sémillon, while elevated hillside parcels retain acidity and herbal freshness. Producers combine traditional barrel fermentation and lees maturation for old-vine Sémillon with polished French oak aging for structured red blends.",
