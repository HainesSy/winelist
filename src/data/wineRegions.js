...
export const WINE_REGIONS = {
  ...
  'corsica': {
    ...
    country: 'France',
    countryCode: 'FR',
    aliases: ['corsica', 'corse', 'patrimonio', 'ajaccio', 'calvi', 'figari', 'porto-vecchio', 'sartene', 'sartène', 'cap corse', 'coteaux du cap corse', 'muscat du cap corse', 'ile de beaute', 'île de beauté', 'carco', 'grotte di sole', 'clos d alzeto', 'clos canarelli'],
