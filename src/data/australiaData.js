...
export const AUSTRALIA_SUBREGIONS = [
  {
    ...
    description: "Settled in the 1840s by Silesian Lutheran immigrants fleeing religious persecution in Prussia, the Barossa Valley is Australia's most revered fine wine treasury and home to the oldest continually producing, ungrafted pre-phylloxera Shiraz vines on Earth—some dating back to 1843. The warm Mediterranean continental climate, with long dry summers sheltered by the Mount Lofty Ranges, produces wines of monumental concentration, sweet blackberry fruit, and velvety tannins from ancient bush vines yielding as little as one tonne per hectare. Deep alluvial red-brown earth and ironstone loam soils on the valley floor provide low-fertility conditions that naturally restrict vigour, while the Barossa Old Vine Charter protects vines classified as Centenarian (100+ years), Survivor (75+ years), and Old Vine (35+ years). Penfolds Grange, first crafted by Max Schubert in 1951 using multi-regional Shiraz aged in American oak hogsheads, remains Australia's most iconic wine and was declared a Heritage Icon of South Australia. The traditional Barossa GSM blend (Grenache-Shiraz-Mourvèdre) and fortified Tawny styles continue a winemaking lineage unbroken since the 1840s.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The elevated, cool-climate soul of the Barossa Ranges, perched at 400–550 metres on windswept hilltops of weathered mica schist and gneiss, celebrated for producing some of the longest-lived dry Rieslings and single-vineyard Shiraz on Earth. Eden Valley Riesling—bone-dry, electric with lime juice and talc—rivals the Mosel for longevity, developing extraordinary toast, lanolin, and honeycomb complexity over 20–30 years of cellaring. The region's most iconic vineyard, Henschke Hill of Grace, contains pre-phylloxera ungrafted Shiraz vines planted in 1860 at Keyneton, producing one of Australia's two most revered wines alongside Penfolds Grange. The significantly cooler temperatures at altitude—2 to 3 weeks behind the Barossa Valley floor in ripening—preserve bracing natural acidity and amplify the perfumed, five-spice, sage-scented aromatics unique to cool-climate Australian Shiraz. Pewsey Vale, Grosset Polish Hill, and Mountadam further demonstrate the extraordinary range of this compact but profoundly important region.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Established in 1967 following Dr. John Gladstones' groundbreaking viticultural research paper identifying the Leeuwin-Naturaliste Ridge as climatically analogous to Bordeaux, Margaret River has evolved into Australia's supreme maritime fine wine paradise. Surrounded on three sides by the Indian and Southern Oceans, this peninsula enjoys a frost-free, Mediterranean-maritime climate where consistent sea breezes—the famous 'Fremantle Doctor'—moderate summer heat and create conditions virtually identical to Bordeaux's greatest vintages. Ancient Precambrian granite and lateritic gravel-loam soils along the Leeuwin-Naturaliste Ridge provide excellent drainage and low fertility, concentrating flavours in both Cabernet Sauvignon and Chardonnay, the region's dual pillars of excellence. Cullen Diana Madeline, Moss Wood, and Vasse Felix represent the pioneer estates from the early 1970s, while Leeuwin Estate's Art Series Chardonnay is consistently ranked among the top five Chardonnays in the world. Despite producing less than 3% of Australia's total wine, Margaret River accounts for over 20% of the nation's premium wine market.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Australia's oldest continuous wine region, planted in the 1820s by James Busby—the 'Father of Australian Viticulture'—who collected vine cuttings from France and Spain on his landmark 1831 European tour. The Hunter Valley is world-famous for its utterly unique Semillon tradition: picked remarkably early at just 10–11% potential alcohol and bottled without oak aging, these wines start as crisp lemon-water and transform over 15–25 years of cellaring into honeyed, toasty, waxy masterpieces unlike anything else in the wine world. The challenging subtropical-maritime climate, with heavy summer harvest rains and humidity, paradoxically produces restrained, medium-bodied Shiraz of extraordinary savoury complexity—leather, earth, and dark spice—thanks to protective afternoon cloud cover rolling in from Newcastle and the Brokenback Range. Volcanic red clay over sandstone on the foothills provides optimal drainage, while alluvial sandy loam on the flats prevents waterlogging during monsoonal rains. Tyrrell's Vat 1 Semillon and Brokenwood Graveyard Shiraz represent two of Australia's most collected and age-worthy wines from this historic region.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "The Limestone Coast's crown jewel, founded in 1890 by Scottish-born pastoralist John Riddoch, and recognized worldwide for its striking terra rossa—a vivid red clay loam just 15 centimetres deep overlaying porous white Gambier limestone bedrock. This legendary cigar-shaped strip measures only 1.5 kilometres wide by 15 kilometres long, making it one of the most precisely defined wine terroirs in the New World and the subject of intense boundary disputes. The cool maritime climate, moderated by persistent Antarctic currents and icy Southern Ocean breezes, provides a long, slow growing season ideal for Cabernet Sauvignon, which achieves an elegant, Bordeaux-like structure with hallmark eucalyptus, blackcurrant, and cedar complexity. The porous limestone acts as a natural aquifer, with vine roots penetrating deep into fractures to access subterranean water, eliminating the need for surface irrigation. Wynns Coonawarra Estate (John Riddoch Cabernet), Balnaves, and Parker Estate produce benchmark cool-climate Cabernets of aristocratic tannin structure and 20–30 year cellaring potential.",
    microTerroirs: [
