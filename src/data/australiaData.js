...
export const AUSTRALIA_SUBREGIONS = [
  {
    ...
    terroir: "Warm valley floor consisting of deep alluvial loam, red-brown earth, and cracking clays over ironstone and limestone. Warm temperatures and moisture-retaining red clay soils allow pre-phylloxera ungrafted bush vines to ripen fully, yielding small, concentrated Shiraz berries with high sugar and bold, velvety tannins. Winemakers traditionally practice open-top fermentation with pump-overs, followed by extended aging in American and French oak hogsheads to tame the formidable tannin concentration.",
    ...
    description: "The Barossa Valley sits sixty kilometers northeast of Adelaide in South Australia, preserving the world's oldest continually producing ungrafted pre-phylloxera Shiraz vines. Lutheran immigrants from Prussia arrived in the 1840s, clearing bushland to plant low-yielding bush vines and founding generational estates that endure today. In 1951, chief winemaker Max Schubert secretly experimented with oak maturation at Penfolds, creating Grange and revolutionizing Australian fine wine prestige. Ancient dry-farmed bush vines yield monumental reds bursting with blackberry preserves, savory dark chocolate, and multi-decade cellaring longevity.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Windswept rolling hills (400m to 550m) composed of ancient granitic sandy loam, weathered schist, and ironstone gravels. Strong diurnal cooling and nutrient-deficient soils restrict vine vigor, producing small berries with high natural acidity, floral lime zest monoterpenes in Riesling, and peppery nuances in Shiraz. Riesling is processed through protective, inert-gas whole-bunch pressing with cool tank fermentations, while Shiraz benefits from partial whole-cluster inclusion and neutral puncheons.",
    ...
    description: "Eden Valley occupies the elevated eastern ridge of the Barossa Ranges at elevations reaching five hundred meters above sea level. English pastoralist Joseph Gilbert planted the historic Pewsey Vale vineyard in 1847, establishing the region's enduring benchmark for dry Riesling viticulture. Nearby, the Henschke family has tended ungrafted centenarian vines at the fabled Hill of Grace vineyard since 1868, preserving an unbroken generational winemaking heritage. Cold nocturnal breezes produce bone-dry Rieslings with piercing lime acidity alongside cool-climate Shiraz laced with crushed sage and exotic spice.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Gently undulating coastal ridges along the Leeuwin-Naturaliste ridge feature well-drained ironstone gravelly loam over clay subsoils. Strong maritime breezes from the Indian and Southern Oceans moderate summer heat, extending the ripening window to develop fine-grained tannins and pyrazine-free cassis in Cabernet, and racy acidity in Chardonnay. Chardonnays undergo whole-bunch pressing and frequent lees stirring in French barriques, while Cabernet receives gentle pump-overs to craft elegant structural balance.",
    ...
    description: "Margaret River occupies a coastal peninsula in southwestern Western Australia, bounded on three sides by the Indian and Southern Oceans. Agronomist John Gladstones published a seminal 1967 study identifying the district's maritime Mediterranean climate as Australia's premier natural parallel to Bordeaux. Founding estates including Vasse Felix, Cullen, Moss Wood, and Leeuwin Estate rapidly established global acclaim for estate-grown Cabernet Sauvignon and complex Chardonnay. Ocean winds and maritime breezes moderate ripening temperatures, producing wines of remarkable cassis purity, cedar complexity, and saline freshness.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "Subtropical undulating hills feature weathered red volcanic basalt on ridge slopes and friable alluvial sandy loam along creek flats. High summer humidity and summer rains require early hand-picking, yielding Semillon grapes with low potential alcohol (10–11% ABV) and towering natural acid levels. Semillon is fermented completely dry in stainless steel without oak or malolactic conversion, bottling early to allow decades of reductive bottle maturation to evolve into toasty, honeyed complexity.",
    ...
    description: "The Hunter Valley sits 160 kilometers north of Sydney in New South Wales, serving as the historical cradle of Australian commercial viticulture since the 1820s. Pioneer James Busby introduced European vine cuttings to the valley, laying the foundation for legendary multi-generational family houses like Tyrrell's and Mount Pleasant. Famed winemaker Maurice O'Shea pioneered parcel-selected table wines in the 1920s, elevating the valley's distinctively savory, medium-bodied Shiraz style. Taut Hunter Semillon harvested early without oak evolves over decades into a waxy, honeyed masterpiece alongside leathery, earth-tinged reds.",
    microTerroirs: [
  ...
  },
  {
    ...
    terroir: "A legendary cigar-shaped ridge of porous, bright red terra rossa topsoil (clay-loam rich in iron oxide) overlying permeable calcrete limestone. The free-draining terra rossa suppresses excessive vigor while the underlying limestone stores subterranean moisture, creating balanced hydric conditions that yield thick-skinned Cabernet grapes with vivid cassis and mint. Winemakers utilize prolonged skin contact and aging in tight-grained French and American oak barriques, allowing micro-oxygenation to soften the firm, muscular tannins.",
    ...
    description: "Coonawarra forms a narrow fifteen-kilometer cigar-shaped ridge within South Australia's far southeastern maritime zone, established by Scottish pastoralist John Riddoch in 1890. Riddoch planted extensive orchards and vineyards, constructing the historic gabled triple-arch stone winery that became the architectural symbol of Wynns Coonawarra Estate. The district revived following World War II as visionary producers recognized the cool Southern Ocean air currents as ideal for long, slow ripening. Benchmark Cabernet Sauvignons showcase structured blackcurrant, eucalyptus, and refined cedar notes supported by sculpted tannins capable of aging for forty years.",
    microTerroirs: [
