...
export const AUSTRALIA_SUBREGIONS = [
  {
    ...
    description: "Settled in the 1840s by Silesian immigrants, the Barossa Valley preserves the planet's oldest continually producing pre-phylloxera Shiraz vines. It was here in 1951 that visionary winemaker Max Schubert secretly conceived Penfolds Grange, forever redefining Australian fine wine. Ancient bush vines yield monumental reds bursting with blackberry liqueur, dark cocoa, and half a century of cellaring power.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Perched high in the windswept Barossa Ranges, Eden Valley is celebrated for laser-pure dry Rieslings and transcendent cool-climate Shiraz. Historic Pewsey Vale first championed Riesling here in 1847, while Henschke's fabled Hill of Grace vineyard has nurtured ungrafted centenarian vines since 1860. Crisp alpine breezes lock in electric lime acidity and perfume wines with crushed sage, exotic spice, and aristocratic longevity.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Surrounded by the turquoise waters of the Indian and Southern Oceans, Margaret River was identified in 1967 as Australia's climatic mirror to Bordeaux. Pioneer estates like Leeuwin, Cullen, and Moss Wood established an international reputation for ocean-cooled Cabernet Sauvignon and world-beating Art Series Chardonnay. The cooling afternoon 'Fremantle Doctor' breeze preserves vibrant maritime freshness, cassis elegance, and hazelnut-scented textural richness.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Established in the 1820s by viticultural pioneer James Busby, the historic Hunter Valley is home to Australia's most mesmerizing white wine phenomenon. Picked early and vinified without oak, Hunter Semillon starts as taut citrus before blossoming over decades into honeyed, waxy, and toasty splendor. Historic houses like Tyrrell's and Mount Pleasant also craft medium-bodied, savory Shiraz scented with leather and warm spice.",
    microTerroirs: [
  ...
  },
  {
    ...
    description: "Founded in 1890 by Scottish pastoralist John Riddoch, Coonawarra is Australia's supreme sanctuary for cool-climate Cabernet Sauvignon. A narrow cigar-shaped ridge cooled by icy Antarctic currents yields reds of aristocratic poise and architectural precision. Benchmark bottlings from Wynns and Balnaves showcase signature blackcurrant, eucalyptus, cedar, and sculpted tannins that mature effortlessly across thirty to forty years.",
    microTerroirs: [
